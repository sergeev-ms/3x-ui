...
```
bash <(curl -Ls https://raw.githubusercontent.com/sergeev-ms/3x-ui/master/install.sh)
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/sergeev-ms/3x-ui/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/sergeev-ms/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **Clone the Project Repository:**
   ...
   ```sh
   git clone https://github.com/sergeev-ms/3x-ui.git
   cd 3x-ui
   ```
